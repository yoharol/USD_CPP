...
int main(int argc, char **argv) {
  ...
  GLFWwindow *window = glfwCreateWindow(1024, 768, "Triangle", nullptr, nullptr);
  if (!window)
	return -1;
  ...
  pxr::UsdStageRefPtr stage = pxr::UsdStage::Open(asset_path + "/Forest_House.usdz");
  if (!stage) {
  ...
  renderer.set_orbit_control(Eigen::Vector3d(-100.0, 40.0, 0.0), Eigen::Vector3d(0.0, 5.0, 0.0));
